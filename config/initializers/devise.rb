...
Devise.setup do |config|
  ...
  config.omniauth :facebook, 834590109976033, ENV["FACEBOOK_SECRET"],  scope: 'email, public_profile', info_fields: 'email, first_name, last_name, gender', :image_size => 'large'
